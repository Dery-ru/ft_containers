...
int main(int argc, char *argv[]){
	...
	if (note == (char*)("operator=") || note == (char*)("all"))
	{
	...
	for (PH::vector<int>::iterator it = myvector1.begin() ; it != myvector1.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << "\n\tmyvector reverse:";
	for (PH::vector<int>::reverse_iterator it = myvector1.rbegin() ; it != myvector1.rend(); ++it)
		std::cout << ' ' << *it;
	std::cout << '\n';
	}
	if (note == "to_end" || note == "all")
	{
	...
	if (note == "reverse_to_end" || note == "all")
	{
	...
	if (note == "change_capacity" || note == "all")
	{
